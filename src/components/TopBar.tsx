      ...
      <div className="container flex h-16 items-center justify-between">
        ...
        <div className="flex items-center gap-6">
          ...
          <nav className="hidden lg:flex items-center gap-1">
            ...
            <NavLink to="/train" className="text-sm font-medium">Train</NavLink>
            <NavLink to="/calendar" className="text-sm font-medium">Calendar</NavLink>
            <NavLink to="/progress" className="text-sm font-medium">Progress</NavLink>
          </nav>
        </div>
